...
## Fase 7: Série Histórica Econômica (Em Progresso)
- [ ] Criar arquivo economia-historica.json com dados 2020-2024
- [ ] Adicionar PIB e população históricos para principais municípios
- [ ] Implementar gráfico LineChart de tendência de PIB
- [ ] Implementar gráfico LineChart de tendência de população
- [ ] Adicionar comparação ano-a-ano (crescimento %)
- [ ] Integrar dados históricos na procedure ibgeCidades
- [ ] Adicionar testes para série histórica
- [ ] Validar gráficos de tendência no portal
